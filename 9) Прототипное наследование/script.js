...
Rectangle.prototype.info = function () {
	return "X: " + this.getCoordinCenterX() + ", Y: " + this.getCoordinCenterY() + ", Diagonal: " + this.getLengthDiagonal();
};
...
Circle.prototype.info = function () {
	return "X: " + this.getCoordinCenterX() + ", Y: " + this.getCoordinCenterY() + ", Radius: " + this.getRadiusCircle();
};
